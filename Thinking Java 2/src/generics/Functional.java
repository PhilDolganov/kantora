...
interface Collector<T> extends UnaryFunction<T, T> { T result(); // Extract result of collecting parameter
}
...
public class Functional {
    ...
    static class MultiplyIntegerCollector implements Collector<Integer> {
    ...
    public static void main(String[] args) {
        ...
        print(forEach(li, new MultiplyIntegerCollector()).result());

        print(forEach(filter(li, new GreaterThan<Integer>(4)), new MultiplyIntegerCollector()).result());
