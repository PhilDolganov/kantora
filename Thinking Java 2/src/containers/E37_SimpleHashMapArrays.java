...
public class E37_SimpleHashMapArrays {
    public static void main(String[] args) {
        ...
        Tester.run(new SimpleHashMap4<>(),E35_MapPerformance2.tests);
        Tester.run(new SimpleHashMap5<>(),E35_MapPerformance2.tests);
        Tester.run(new SimpleHashMap6<>(),E35_MapPerformance2.tests);
    }
}
