...
class CompareSecondAlphabetic implements Comparator<TwoStringAlphabetic>{
    ...
    public int compare(TwoStringAlphabetic sc1, TwoStringAlphabetic sc2) {
        return sc1.s1.toLowerCase().compareTo(sc2.s2.toLowerCase());
    }
}
public class E42_AlphaComparable {
    public static void main(String[] args) {
        ...
        ArrayList<TwoStringAlphabetic> list = new ArrayList<>(CollectionData.list(TwoStringAlphabetic.generator(), 10));
