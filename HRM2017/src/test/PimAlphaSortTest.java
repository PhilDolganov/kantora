...
public class PimAlphaSortTest extends AdminAuthenticateTest {
    ...
    public void sortByFirstName() {
        ...
        while (true) {
            ...
            for (WebElement firstName : allFirstNames) {
                ...
                assertTrue("Expected '" + previous + "' to be alphabetically before '" + current + "'",previous.compareToIgnoreCase(current) <= 0);
                previous = current;
            }
            String[] pagination;
            try {
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@class = 'current' and text()='" + (pageNum + 1 ) + "']")));
        }
    }
}
