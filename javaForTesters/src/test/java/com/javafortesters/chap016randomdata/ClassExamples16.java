...
public class ClassExamples16 {
    ...
    public void utilRandom(){
        ...
        boolean randomBolean = generate.nextBoolean();
        int randomInt = generate.nextInt();
        int randomRange = generate.nextInt(12);
        long randomLong = generate.nextLong();
        double randomDouble = generate.nextDouble();
        double randmGaussian = generate.nextGaussian();
    ...
    public void canGenerateRandomBoolean(){
        ...
        System.out.println(String.format("Generated %d as true",countTrue));
        System.out.println(String.format("Generated %d as false", countFalse));
    ...
    @Test
    public void checkForIntRange(){
        Random generate = new Random();
        int randomRange = generate.nextInt(12);
        System.out.println(randomRange);
        assertThat(randomRange <= 11, is(true));
        assertThat(randomRange >= 0, is(true));
    }

    @Test
    public void intBelow(){
        Random generate = new Random();
        int minValue = 1;
        int maxValue = 5;
    ...
    @Test
    public void genIntInRange(){
        Random generate = new Random();
        int minValue = 15;
        int maxValue = 20;
        for (int i = 0; i < 1000; i++) {
            int randomRange = generate.nextInt(maxValue - minValue + 1) + minValue;
            System.out.println(String.format("random value is %d ", randomRange ));
            assertThat(randomRange <= maxValue, is(true));
            assertThat(randomRange >= minValue, is(true));
        }
    }
    ...
    public void canGenerateRandomGaussianDistributionDouble(){
        ...
        // I do not assert that sd3 & sd4 are different, because of the small % difference, they do overlap
    }
