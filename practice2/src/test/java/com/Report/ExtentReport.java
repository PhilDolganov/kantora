...
public class ExtentReport {
    ...
    public void startTest(){
        ...
        reports.setSystemInfo("Machine", "Lapusik");
    ...
    public void fillRegistrationFormTest(){
        ...
        WebElement firstName = driver.findElement(By.cssSelector("input[id='u_0_e']"));
        WebElement lastName = driver.findElement(By.name("lastname"));
        WebElement submitButton = driver.findElement(By.id("u_0_w"));
...
//        throw new SkipException("Skip test forecfully");
//
//    }
