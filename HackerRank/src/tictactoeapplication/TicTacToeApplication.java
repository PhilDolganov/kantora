...
public class TicTacToeApplication {
    ...
    public static void main(String[] args) {
        ...
        // Allows for cont. game
        boolean doYouWantToPlay = true;

        while (doYouWantToPlay) {
            // Setting up tokens and AI
            System.out.println("Welcome to TicTacToe! You are about to go against "
                    + "the master of Tic Tac Toe. Are you ready? I hope so!\n BUT FIRST, you"
                    + " must pick what character you want to be and which character I will be");
            System.out.println();
            System.out.println("Enter a singe character that will represent you on the board");
            char playerToken = sc.next().charAt(0);
            System.out.println("Enter a single character that will represent your opponent n the board");
